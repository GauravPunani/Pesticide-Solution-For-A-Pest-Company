...
$contract=$wpdb->get_row("select * from {$wpdb->prefix}maintenance_contract where id='{$_SESSION['monthly_maintenance_editable']['id']}'");
...
<div class="row">
    <div class="col-md-offset-2 col-md-8">
        <div class="card">
            <div class="card-head">
                <h4 class="text-center">Edit Monthly Maintenance Contract</h4>
            </div>
            <div class="card-body">
