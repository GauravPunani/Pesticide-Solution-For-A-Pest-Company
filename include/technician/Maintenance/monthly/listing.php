...
$total_pages_sql = "select COUNT(*) from  {$wpdb->prefix}maintenance_contract where type='monthly' and technician_id='{$user->id}' $whereSearch";
...
$result = $wpdb->get_results("select * from {$wpdb->prefix}maintenance_contract where type='monthly' and technician_id='{$user->id}' $whereSearch order by date DESC LIMIT $offset, $no_of_records_per_page");

?>

<div class="top_wrapper">
    <h3 class="text-center">Monthly Maintenance Contracts</h3>
