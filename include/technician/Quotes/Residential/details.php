<?php
// echo "<pre>";print_r($_SESSION['residential_quote_editable']);wp_die();
if(isset($_SESSION['residential_quote_editable'])){
    if(isset($_SESSION['residential_quote_editable']['id']) && !empty($_SESSION['residential_quote_editable']['id'])){
...
<?php if($quote): ?>
    <div class="row">
        <div class="col-md-offset-2 col-md-8">
            ...
            <h1 class="text-center">Quote #<?= $quote->quote_no; ?></h1>
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td><?= (!empty($quote->tech_diff_name)) ? $quote->tech_diff_name : $quote->first_name." ".$quote->last_name; ?></td>
                    </tr>
                </table>
                <table class="table table-striped table-hover">
