        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="page-header">Verifiy Door To Door Application</h3>
                    ...
                    <form id="verify_door_to_door" action="<?= admin_url('admin-post.php'); ?>" method="post">

                        <?php wp_nonce_field('verify_door_to_door'); ?>
                        <input type="hidden" name="action" value="verify_door_to_door">
