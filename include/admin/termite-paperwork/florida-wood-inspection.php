...
$florida_report=$wpdb->get_results("
    select N.id, N.technician_id, N.client_name, N.client_email, N.address_of_property, N.pdf_link, N.date_created, T.first_name, T.last_name
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card full_width table-responsive">
                <div class="card-body">
                    <h3 class="page-header">Florida Wood Inspection Report</h3>
