        ...
        <div class="col-md-12">
            <div class="card full_width table-responsive">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="page-header">Total Amount Owed <b><?= (new GamFunctions)->beautify_amount_field($total_amount_owed); ?></b></h4>
                        ...
                        <div class="col-md-6">
                            <div class="row pull-right">
                                <?php if (isset($_GET['tab']) && !empty($_GET['tab']) && $_GET['tab'] == '30_days_due') : ?>
                                    <button class="btn btn-success move_client_to_in_collection" disabled><span><i class="fa fa-arrows"></i></span> Move To In Collections</button>
                                <?php endif; ?>
                                <button class="send_multiple_mini_statements btn btn-primary" disabled><span><i class="fa fa-envelope"></i></span> Send Mini Statments</button>
                            </div>
                        </div>
                    </div>
