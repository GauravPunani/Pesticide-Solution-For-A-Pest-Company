...
/* Template Name: Technician Login*/
    ...
    <div class="col-md-12">
        <div class="login-form">
            <form id="technician_login_form" action="" method="post">
                <h2 class="text-center">Technician Log in</h2>       
                <div class="login-errors"></div>
				<?php wp_nonce_field('technician_login'); ?>
                        ...
                        success:function(data){
                            if(data.status=="success"){
                                ...
                                if(redirect_to!=undefined && redirect_to!=''){
                                    ...
                                    window.location.replace("<?= site_url(); ?>/technician-dashboard");                                
                                }
                                ...
                                $('.login-errors').html("<p class='text-danger'>Incorrect username or password</p>");
